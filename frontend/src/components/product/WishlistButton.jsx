...
function WishlistButton({ product, className = "", size = "sm" }) {
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={`flex items-center justify-center rounded-full border border-border-light bg-white/95 text-text-secondary shadow-sm transition hover:border-primary hover:text-primary ${sizeClass} ${
