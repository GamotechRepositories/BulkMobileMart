...
function ContactCard({ icon, iconBg, title, children, href, external }) {
  ...
  return (
    <a
      href={href}
      {...linkProps}
      className="block rounded-xl border border-border-light bg-white p-4 shadow-sm transition hover:border-primary/40 hover:shadow-md sm:p-5"
    >
      {content}
    </a>
  );
...
function Support() {
  ...
  return (
    <div className="bg-mobile-bg text-text-primary">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid items-start gap-6 lg:grid-cols-[1fr_1.15fr] lg:gap-8 xl:gap-10">
            <div className="space-y-4">
              ...
              >
                <p className="mt-1 text-sm font-semibold text-primary">{SUPPORT_CONTACT.phone}</p>
                <p className="mt-0.5 text-xs text-text-secondary">Mon – Sat · 10:00 AM – 7:00 PM IST</p>
              </ContactCard>
              ...
              >
                <p className="mt-1 text-sm font-semibold text-green-600">{SUPPORT_CONTACT.whatsapp}</p>
                <p className="mt-0.5 text-xs text-text-secondary">Chat with us on WhatsApp</p>
              </ContactCard>
              ...
              >
                <p className="mt-1 text-sm font-semibold text-primary">{SUPPORT_CONTACT.email}</p>
                <p className="mt-0.5 text-xs text-text-secondary">We reply within 24 hours</p>
              </ContactCard>
              ...
              >
                <p className="mt-1 text-sm text-text-secondary">Monday – Saturday: 10:00 AM – 7:00 PM</p>
      ...
      <section className="border-t border-border-light bg-white px-3 py-6 sm:px-4 lg:px-8 lg:py-8">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5 lg:gap-6">
          {TRUST_BADGES.map((badge) => (
            <div key={badge.title} className="flex flex-col items-center text-center">
              <div className="mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary">
                {badge.icon}
              </div>
              <h3 className="text-xs font-bold text-text-primary sm:text-sm">{badge.title}</h3>
              <p className="mt-0.5 text-[10px] text-text-secondary sm:text-xs">{badge.desc}</p>
            </div>
          ))}
        </div>
      </section>
